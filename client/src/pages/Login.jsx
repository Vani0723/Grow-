  ...
  return (
    <div className="w-full max-w-md mx-auto my-12 p-8 groww-card space-y-6">
      <div className="text-center space-y-2">
        ...
        <h2 className="text-2xl font-black text-slate-900">Log In to Groww</h2>
        <p className="text-xs text-slate-500 font-medium">Access your synchronized smart market watchlist</p>
      </div>
      ...
      <p className="mt-4 text-center text-xs text-slate-500 font-medium">
        ...
        <Link to="/register" className="text-[#00d09c] font-bold hover:underline">
          Register here
        </Link>
      </p>
    </div>
